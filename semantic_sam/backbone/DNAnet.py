...
@register_backbone
def get_dna_backbone(cfg):
    return DNANet(num_classes=1,input_channels=3, block=Res_CBAM_block, num_blocks=[2, 2, 2, 2], nb_filter=[16, 32, 64, 128, 256], deep_supervision=True)
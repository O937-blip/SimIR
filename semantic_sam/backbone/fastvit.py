...
from semantic_sam.modules.MobileOneBlock import MobileOneBlock
from semantic_sam.modules.replknet import ReparamLargeKernelConv
...
@register_backbone
def get_s_fastvitmodified_backbone(cfg):
    print('HEY ITS S BACKBONE')
    layers = [2, 2, 4, 2]
    embed_dims = [48, 96, 192, 384]
    mlp_ratios = [3, 3, 3, 3]
    downsamples = [True, True, True, True]

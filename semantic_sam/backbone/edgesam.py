...
from .commonforedgesam import LayerNorm2d, UpSampleLayer, OpSequential
...
@register_backbone
def repvit_m1(cfg, lang, pretrained=False, num_classes=1000, distillation=False):
    """
    Constructs a MobileNetV3-Large model
    """
    return RepViT('m1', img_size=512)
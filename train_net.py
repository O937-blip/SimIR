...
class Trainer(DefaultTrainer):
    ...
    def build_hooks(self):
        ...
        ret.append(hooks.BestCheckpointer(cfg.TEST.EVAL_PERIOD, self.checkpointer,'mIoU'))
        if comm.is_main_process():
        ...
        for dataloader, dataset_name in zip(dataloaders, dataset_names):
            ...
            with torch.no_grad():
                ...
                if 'sam' in dataset_names:
                    ...
                    task = 'sirst'
                elif dataset_name == 'IRSTD_test':
                    task = 'sirst'
                elif dataset_name == 'MDFA_test':
                    task = 'sirst'
                elif dataset_name == 'IRDST_test':
                    task = 'IRDST'
                else:
                    task = 'interactive'
